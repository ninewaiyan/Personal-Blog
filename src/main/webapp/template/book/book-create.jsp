			...
			<form action="book" method="POST" enctype="multipart/form-data">
				...
				<div class="mb-3">
					<label for="postTitle" class="form-label">Name</label> <input
						...
						placeholder="Enter book name" required value="${name }">
				</div>
				...
				<!-- Media Upload Input -->
				<div class="mb-3">
					<label for="" class="form-label">Upload BOOK PDF </label> <input
						type="file" class="form-control-file" id="" name="bookfile"
						accept="application/*" required> <br> <small
						class="form-text"> Upload PDF </small>
				</div>

				<!-- Submit Button -->
				<div class="d-flex justify-content-end">
				<a type="button" class="btn btn-secondary cancel me-2" href="book">Cancel</a>
