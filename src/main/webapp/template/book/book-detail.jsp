				...
				<div class="product-image">
					...
					<div class="product-info">
						<a class="btn text-info btn-outline-primary"
							href="${pageContext.request.contextPath}/template/book/BookMedia/${book.bookfile}"
							target="_blank">
			...
			<div class="col-md-6">
				<div class="product-description">
					...
					<c:if test="${sessionScope.user.role eq 'admin' }">
						...
						<div class="">
							<a href="book?mode=EDIT&id=${book.id }" class="btn btn-outline-success">Edit</a>

							<a class="btn btn-outline-danger" data-bs-toggle="modal"
								data-bs-target="#deleteModal${book.id}">Delete</a>
						</div>
						</div>
