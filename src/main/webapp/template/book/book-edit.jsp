			...
			<div class="col-md-6">
				<div class="product-image">
					...
					<div class="product-info">
						<a class="btn text-info btn-outline-primary"
							href="${pageContext.request.contextPath}/template/book/BookMedia/${book.bookfile}"><h4
								class="mb-1">Download</h4></a>
				...
				<div class="product-description">
					...
					<c:if test="${sessionScope.user.role eq 'admin' }">
						...
						<form action="book" method="POST" enctype="multipart/form-data">
							...
							<!-- Title Input -->
							<div class="mb-3">
								<label for="postTitle" class="form-label"><h3>Book
										Name</h3></label> <input type="text" class="form-control" id="postTitle"
									name="name" 
							...
							<div class="mb-3">
								...
								<textarea class="form-control" id="postContent"
									...
									placeholder="Write Description ........." required>${book.description }</textarea>
							</div>

							<!-- Submit Button -->
							<div class="d-flex justify-content-end">
								<button type="submit" class="btn btn-primary me-2">Edit</button>
								<a type="button" class="btn btn-secondary" href="book">Cancel</a>
							</div>
						</form>
					</c:if>
				</div>
