...
<c:if
	...
	<div class="container main-content">
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 mb-4 ml-4"></div>

			<div class="col-md-4 col-sm-6 mb-4 ml-4">
					...
					<div class="card-body">
						<form action="course" method="POST" enctype="multipart/form-data">
							...
							<div class="d-flex justify-content-end ">
								...
								<a type="button" class="btn btn-secondary " href="course">Cancel</a>
							</div>
						</form>
