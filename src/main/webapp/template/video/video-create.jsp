			...
			<form action="watch" method="POST" enctype="multipart/form-data">
				...
				<div class="mb-3">
					<label for="postTitle" class="form-label">Title</label> <input
						...
						placeholder="Enter Title" required value="${title }">
				</div>
				
				<!-- Media Upload Input -->
				<div class="mb-3">
					<label for="" class="form-label">Upload Video
						</label> <input type="file" class="form-control-file"
						id="" name="video" accept="video/*" required>
					<br> <small class="form-text"> Only .mp4 and .mpeg </small>
				</div>

				<!-- Submit Button -->
				<div class="d-flex justify-content-end">
					<a type="button" class="btn btn-secondary cancel me-2" href="watch?mode=WATCH&course_id=${course_id }">Cancel</a>
